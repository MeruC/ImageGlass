...
public partial class AppAPIProvider
{
    ...
    public static IReadOnlyCollection<HotkeySingleAction> DefaultMenuList => [
        ...
        new(LangId.ImageOrderBy_Name,               API.IG_ToggleLoadingOrderBy,    nameof(ImageOrderBy.Name),         [new(Hotkey.Ctrl | MKeys.Alt, Key.A)]),
        ...
        new(LangId.ImageOrderBy_DateModified,       API.IG_ToggleLoadingOrderBy,    nameof(ImageOrderBy.DateModified), [new(Hotkey.Ctrl | MKeys.Alt, Key.D)]),
        ...
        new(LangId.Menu_MnuCropTool,            API.IG_ToggleTool, CropImageToolControl.TOOL_ID,        [new(Hotkey.Ctrl | MKeys.Alt, Key.C)]),
        new(LangId.Menu_MnuQuickCrop,           API.IG_ToggleTool, QuickCropToolControl.TOOL_ID,        [new(MKeys.Alt, Key.Q)]),
        new(LangId.Menu_MnuRenamer,             API.IG_ToggleTool, RenamerToolControl.TOOL_ID,          [new(MKeys.Alt, Key.N)]),
